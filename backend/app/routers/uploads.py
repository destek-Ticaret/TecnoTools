...
async def upload_image(request: Request, file: UploadFile = File(...), user: User = Depends(require_editor)):
    ...
    ext = EXT_BY_TYPE.get(file.content_type) or mimetypes.guess_extension(file.content_type) or ".bin"
