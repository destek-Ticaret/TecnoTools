...
(function (global) {
  ...
  var DICT = {
    ...
    // Çerez tercihleri (consent modal)
    "🍪 Çerez Tercihleri": { en:"🍪 Cookie Preferences", de:"🍪 Cookie-Einstellungen", fr:"🍪 Préférences de cookies", es:"🍪 Preferencias de cookies", it:"🍪 Preferenze cookie" },
    "Bu sitede deneyiminizi iyileştirmek için çerezler ve benzer teknolojiler kullanıyoruz. Zorunlu çerezler (oturum, sepet, güvenlik) her zaman aktiftir. Analitik ve pazarlama çerezleri için izninizi istiyoruz.": { en:"We use cookies and similar technologies to improve your experience on this site. Essential cookies (session, cart, security) are always active. We ask your consent for analytics and marketing cookies.", de:"Wir verwenden Cookies und ähnliche Technologien, um Ihr Erlebnis auf dieser Website zu verbessern. Notwendige Cookies (Sitzung, Warenkorb, Sicherheit) sind immer aktiv. Für Analyse- und Marketing-Cookies bitten wir um Ihre Einwilligung.", fr:"Nous utilisons des cookies et des technologies similaires pour améliorer votre expérience sur ce site. Les cookies essentiels (session, panier, sécurité) sont toujours actifs. Nous demandons votre consentement pour les cookies analytiques et marketing.", es:"Usamos cookies y tecnologías similares para mejorar tu experiencia en este sitio. Las cookies esenciales (sesión, carrito, seguridad) siempre están activas. Solicitamos tu consentimiento para las cookies de análisis y marketing.", it:"Utilizziamo cookie e tecnologie simili per migliorare la tua esperienza su questo sito. I cookie essenziali (sessione, carrello, sicurezza) sono sempre attivi. Chiediamo il tuo consenso per i cookie analitici e di marketing." },
    "Gizlilik Politikası": { en:"Privacy Policy", de:"Datenschutzrichtlinie", fr:"Politique de confidentialité", es:"Política de privacidad", it:"Informativa sulla privacy" },
    "KVKK Aydınlatma": { en:"Data Protection Notice", de:"Datenschutzhinweis", fr:"Avis de protection des données", es:"Aviso de protección de datos", it:"Informativa sulla protezione dei dati" },
    "Zorunlu": { en:"Essential", de:"Notwendig", fr:"Essentiels", es:"Esenciales", it:"Essenziali" },
    "· Oturum, sepet, güvenlik. Bu çerezler kapatılamaz.": { en:"· Session, cart, security. These cannot be disabled.", de:"· Sitzung, Warenkorb, Sicherheit. Diese können nicht deaktiviert werden.", fr:"· Session, panier, sécurité. Ils ne peuvent pas être désactivés.", es:"· Sesión, carrito, seguridad. No se pueden desactivar.", it:"· Sessione, carrello, sicurezza. Non possono essere disattivati." },
    "Analitik": { en:"Analytics", de:"Analyse", fr:"Analytique", es:"Analítica", it:"Analitici" },
    "· Sayfa istatistikleri, performans ölçümü (anonim)": { en:"· Page statistics, performance measurement (anonymous)", de:"· Seitenstatistiken, Leistungsmessung (anonym)", fr:"· Statistiques de pages, mesure de performance (anonyme)", es:"· Estadísticas de páginas, medición de rendimiento (anónimo)", it:"· Statistiche delle pagine, misurazione delle prestazioni (anonimo)" },
    "Pazarlama": { en:"Marketing", de:"Marketing", fr:"Marketing", es:"Marketing", it:"Marketing" },
    "· Kişiselleştirilmiş kampanyalar, hedefleme": { en:"· Personalized campaigns, targeting", de:"· Personalisierte Kampagnen, Targeting", fr:"· Campagnes personnalisées, ciblage", es:"· Campañas personalizadas, segmentación", it:"· Campagne personalizzate, targeting" },
    "Yalnızca Zorunlu": { en:"Essential Only", de:"Nur notwendige", fr:"Essentiels uniquement", es:"Solo esenciales", it:"Solo essenziali" },
    "Tercihleri Kaydet": { en:"Save Preferences", de:"Einstellungen speichern", fr:"Enregistrer les préférences", es:"Guardar preferencias", it:"Salva preferenze" },
    "Tümünü Kabul Et": { en:"Accept All", de:"Alle akzeptieren", fr:"Tout accepter", es:"Aceptar todo", it:"Accetta tutto" }
  };
